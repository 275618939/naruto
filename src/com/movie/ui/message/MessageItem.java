...
public abstract class MessageItem {
	...
	protected void fillTimeStamp() {
		...
		if (mMsg.getTime() != 0) {
			mHtvTimeStampTime.setText(DateUtils.formatDate(mContext,mMsg.getTime()));
		}
	...
	protected void fillPhotoView() {
		...
		//mIvPhotoView.setImageBitmap(((NarutoApplication) ((Activity) mContext).getApplication()).getAvatar(mMsg.getAvatar()));
	}
