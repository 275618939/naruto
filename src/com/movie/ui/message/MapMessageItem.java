...
import com.movie.view.ImageMapUtils;
import com.movie.view.ImageMapUtils.OnMapDownloadStateListener;
...
public class MapMessageItem extends MessageItem implements OnClickListener,
	...
	public MapMessageItem(Message msg, Context context) {
		super(msg, context);
		mApplication = ((NarutoApplication) ((Activity) mContext).getApplication());
	...
	private void downloadMap() {
		...
		mImageMapUtils.display(mApplication.longitude, mApplication.latitude);
	}
