...
public class NearPeople extends BaseBean implements Parcelable {
	...
	public static final Parcelable.Creator<NearPeople> CREATOR = new Parcelable.Creator<NearPeople>() {

		@Override
		public NearPeople createFromParcel(Parcel source) {
			...
			NearPeople dynamic = new NearPeople(uid, avatar, isVip,
		...
		@Override
		public NearPeople[] newArray(int size) {
			return new NearPeople[size];
		}
	};
}
