...
public class HttpFilmLoveUpdateService extends BaseService {

	public HttpFilmLoveUpdateService() {
		TAG="HttpFilmLoveUpdateService";
	}
	public HttpFilmLoveUpdateService(Context context) {
