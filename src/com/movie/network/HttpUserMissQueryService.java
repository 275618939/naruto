...
public class HttpUserMissQueryService extends BaseService {


	public HttpUserMissQueryService() {
		TAG="HttpUserMissQueryService";
	
	}
	public HttpUserMissQueryService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			Object filmId=params.get("memberId");
			Object page=params.get("page");
			Object size=params.get("size");
			StringBuilder path=new StringBuilder(Constant.Miss_Touch_Query_API_URL);
			if(null!=filmId){
