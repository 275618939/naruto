...
public class HttpMobileCaptchaService extends BaseService {

	public HttpMobileCaptchaService() {
		TAG="HttpMobileCaptchaService";
	}
	public HttpMobileCaptchaService(Context context) {
		TAG="HttpMobileCaptchaService";
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPost(Constant.Captcha_API_MOBILE_URL, headers, params);
			if (result != null) {	
				try {
