...
public class HttpUPComingMovieService  extends  BaseService{

	public HttpUPComingMovieService() {
		TAG="HttpUPComingMovieService";
		
	}
	public HttpUPComingMovieService(Context context) {
		TAG="HttpUPComingMovieService";
