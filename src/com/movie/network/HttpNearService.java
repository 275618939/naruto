...
public class HttpNearService  extends  BaseService{

	public HttpNearService() {
		TAG="HttpNearService";
	}
	public HttpNearService(Context context) {
		TAG="HttpNearService";
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			StringBuilder path=new StringBuilder(Constant.Member_Near_API_URL);
			if(null!=distance){
