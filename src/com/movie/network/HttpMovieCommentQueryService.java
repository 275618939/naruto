...
public class HttpMovieCommentQueryService extends BaseService {


	public HttpMovieCommentQueryService() {
		TAG="HttpMovieCommentQueryService";
	
	}
	public HttpMovieCommentQueryService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			StringBuilder path=new StringBuilder(Constant.Movie_Comment_Query_API_URL);
			if(null!=filmId){
