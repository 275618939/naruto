...
public class HttpDynamicQueryService extends BaseService {


	public HttpDynamicQueryService() {
		TAG="HttpDynamicQueryService";
	
	}
	public HttpDynamicQueryService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			StringBuilder path=new StringBuilder(Constant.Dynamic_History_API_URL);
			if(null!=memberId){
