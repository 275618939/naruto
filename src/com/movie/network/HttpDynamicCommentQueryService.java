...
public class HttpDynamicCommentQueryService extends BaseService {


	public HttpDynamicCommentQueryService() {
		TAG="HttpDynamicCommentQueryService";
	
	}
	public HttpDynamicCommentQueryService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			Object id=params.get("dynamicId");
			Object page=params.get("page");
			Object size=params.get("size");
			StringBuilder path=new StringBuilder(Constant.Dynamic_Comment_Query_API_URL);
			if(null!=id){
