...
public class HttpAccountForgetService extends BaseService {


	public HttpAccountForgetService() {
		TAG="HttpAccountForgetService";
	
	}
	public HttpAccountForgetService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPost(Constant.Account_Forget_API_URL, headers, params);
			if (result != null) {
				try {
