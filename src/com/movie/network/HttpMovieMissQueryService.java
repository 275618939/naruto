...
public class HttpMovieMissQueryService extends BaseService {


	public HttpMovieMissQueryService() {
		TAG="HttpMovieMissQueryService";
	
	}
	public HttpMovieMissQueryService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			StringBuilder path=new StringBuilder(Constant.Miss_Film_Query_API_URL);
			if(null!=filmId){
