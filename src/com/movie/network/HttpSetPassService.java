...
public class HttpSetPassService extends BaseService {
	...
	public HttpSetPassService() {
		TAG="HttpSetPassService";
	}
	public HttpSetPassService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPost(Constant.SetPwd_API_URL, headers,params);
			if (result != null) {
				try {
