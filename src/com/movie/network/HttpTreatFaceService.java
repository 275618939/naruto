...
public class HttpTreatFaceService extends BaseService {


	public HttpTreatFaceService() {
		TAG="HttpTreatFaceService";
	
	}
	public HttpTreatFaceService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String	result=HttpUtils.requestPut(Constant.Treat_Face_API_URL, headers, params);
			if (result != null) {
				try {
