...
public class HttpRegisterService extends BaseService {

	public HttpRegisterService() {
		TAG="HttpRegisterService";
	}
	public HttpRegisterService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPut(Constant.Regsiter_API_URL, headers,params);
			if (result != null) {
				try {
