...
public class HttpVerifyService extends BaseService {


	public HttpVerifyService() {
		TAG="HttpVerifyService";
	
	}
	public HttpVerifyService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPost(Constant.Verify_API_URL, headers, params);
			if (result != null) {
				try {
