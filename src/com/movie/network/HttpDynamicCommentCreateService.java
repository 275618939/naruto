...
public class HttpDynamicCommentCreateService extends BaseService {


	public HttpDynamicCommentCreateService() {
		TAG="HttpDynamicCommentCreateService";
	
	}
	public HttpDynamicCommentCreateService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String	result=HttpUtils.requestPut(Constant.Dynamic_Comment_Create_API_URL, headers, params);
			if (result != null) {
				try {
