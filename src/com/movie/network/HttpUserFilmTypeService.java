...
public class HttpUserFilmTypeService extends BaseService {

	public HttpUserFilmTypeService() {
		TAG="HttpUserFilmTypeService";
	}
	public HttpUserFilmTypeService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			StringBuilder path=new StringBuilder(Constant.User_FilmType_API_URL);
			if(null!=memberId){
