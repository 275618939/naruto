...
public class HttpMissUpdateService extends BaseService {


	public HttpMissUpdateService() {
		TAG="HttpMissUpdateService";
	
	}
	public HttpMissUpdateService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPost(path.toString(), headers,params);
			if (result != null) {
				try {
