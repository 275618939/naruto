...
public class HttpMovieDetailService  extends  BaseService{

	public HttpMovieDetailService() {
		TAG="HttpMovieDetailService";
		
	}
	public HttpMovieDetailService(Context context) {
		TAG="HttpMovieDetailService";
