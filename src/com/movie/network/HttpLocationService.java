...
public class HttpLocationService  extends  BaseService{

	public HttpLocationService() {
		TAG="HttpLocationService";
	}
	public HttpLocationService(Context context) {
		TAG="HttpLocationService";
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result  = HttpUtils.requestPost(Constant.Member_Location_API_URL, headers, params);
			if (result != null) {		
				try {
