...
public class HttpTreatCommentService extends BaseService {


	public HttpTreatCommentService() {
		TAG="HttpTreatCommentService";
	
	}
	public HttpTreatCommentService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String	result=HttpUtils.requestPut(Constant.Treat_Comment_API_URL, headers, params);
			if (result != null) {
				try {
