...
public class HttpMovieCommentCreateService extends BaseService {


	public HttpMovieCommentCreateService() {
		TAG="HttpMovieCommentCreateService";
	
	}
	public HttpMovieCommentCreateService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPut(Constant.Movie_Comment_Create_API_URL, headers, params);
			if (result != null) {
				try {
