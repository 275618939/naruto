...
public class HttpMissTreatCoinService extends BaseService {


	public HttpMissTreatCoinService() {
		TAG="HttpMissTreatCoinService";
	
	}
	public HttpMissTreatCoinService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPut(Constant.Miss_Treat_API_URL, headers,params);
			if (result != null) {
				try {
