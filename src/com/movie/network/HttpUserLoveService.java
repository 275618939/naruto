...
public class HttpUserLoveService extends BaseService {

	public HttpUserLoveService() {
		TAG="HttpUserLoveService";
	}
	public HttpUserLoveService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			String result = HttpUtils.requestPut(Constant.User_Love_API_URL, headers,params);
			if (result != null) {
				try {
