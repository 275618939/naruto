...
public class HttpMissUserQueryService extends BaseService {


	public HttpMissUserQueryService() {
		TAG="HttpMissUserQueryService";
	
	}
	public HttpMissUserQueryService(Context context) {
	...
	public void requestServer(CallBackService callbackService) {
		...
		try {
			...
			StringBuilder path=new StringBuilder(Constant.Miss_Hope_Query_API_URL);
			if(null!=trystId){
