...
public class NarutoRefreshListView extends HandyListView {
	...
	public NarutoRefreshListView(Context context) {
		super(context);
		init();
	}

	public NarutoRefreshListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public NarutoRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
