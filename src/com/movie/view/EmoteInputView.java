...
import com.movie.R;
import com.movie.adapter.EmoteAdapter;
...
public class EmoteInputView extends LinearLayout implements OnClickListener,
	...
	public void init() {
		...
		mDefaultAdapter = new EmoteAdapter(getContext(),NarutoApplication.getApp().mEmoticons_Zem);
		mEmojiAdapter = new EmoteAdapter(getContext(),NarutoApplication.getApp().mEmoticons_Zemoji);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (mIsSelectedDefault) {
			text = NarutoApplication.getApp().mEmoticons_Zem.get(arg2);
		} else {
			text = NarutoApplication.getApp().mEmoticons_Zemoji.get(arg2);
		}
