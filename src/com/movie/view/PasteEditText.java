...
import com.movie.R;
import com.movie.ui.message.BaseMessageActivity;
...
public class PasteEditText extends EditText{
    ...
    public boolean onTextContextMenuItem(int id) {
        if(id == android.R.id.paste){
            ...
            if(text.startsWith(BaseMessageActivity.COPY_IMAGE)){
//                intent.setDataAndType(Uri.fromFile(new File("/sdcard/mn1.jpg")), "image/*");     
                text = text.replace(BaseMessageActivity.COPY_IMAGE, "");
                ...
                ((Activity)context).startActivityForResult(intent,BaseMessageActivity.REQUEST_CODE_COPY_AND_PASTE);
//                clip.setText("");
            }
        }
