...
public class UserPhotoUploadPopupWindow extends BasePopupWindow implements OnClickListener {
	...
	public UserPhotoUploadPopupWindow(Context context) {
	...
	public UserPhotoUploadPopupWindow(Context context, int width, int height) {
	...
	public void onClick(View v) {
		...
		case R.id.item_popupwindows_camera:
			takeImagePath=PhotoUtils.takePicture((MainActivity)mContext);
			Bimp.takeImagePath=takeImagePath;
			break;

		case R.id.item_popupwindows_Photo:
			PhotoUtils.selectPhoto((MainActivity)mContext);
			break;
