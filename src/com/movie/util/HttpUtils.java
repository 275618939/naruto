...
public class HttpUtils {
	...
	public static String requestPostImages(String url,File[] file,Map<String,Object> params,Map<String,String>headers) {
		return requestImages("POST",url,params,file,headers);
	}
...
private static String requestImages(String method,String url,Map<String,Object> params,File []file,Map<String,String>headers) {
		...
		try{
			...
			for(File tempFile:file){
				...
				sb.append("Content-Disposition:form-data; name=\"content\"; filename=\"" + tempFile.getName() + "\"" + LINE_END);
