...
public class UploadUtil {
	 ...
	 *            请求的URL
	 */
	public void uploadFile(String filePath, String fileKey, String RequestURL,Map<String, String> heads,
		...
		try {
			...
			uploadFile(file, fileKey, RequestURL,heads, param);
		} catch (Exception e) {
			sendMessage(UPLOAD_FILE_NOT_EXISTS_CODE, "文件不存在");
			e.printStackTrace();
			return;
	...
	public void uploadFile(final File file, final String fileKey,
			final String RequestURL,final Map<String, String> heads, final Map<String, String> param) {
		...
		new Thread(new Runnable() { // 开启线程上传文件
					@Override
					public void run() {
						toUploadFile(file, fileKey, RequestURL,heads, param);
					}
				}).start();

	}

	private void toUploadFile(File file, String fileKey, String RequestURL,Map<String, String> heads,
			Map<String, String> param) {
		String result = null;
		requestTime = 0;
		...
		try {
			...
			conn.setRequestProperty("Session-Id", heads.get("Session-Id"));
