...
public class BackMissFragment extends Fragment implements OnClickListener,
	...
	String[] titles = { getResources().getString(R.string.miss_lately), getResources().getString(R.string.miss_best)};
	ViewPager pager;
	DisplayMetrics dm;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_miss, null);
